<div class="wrapper-charts">
    ...
    <div class="buttons-top">
        <button id="add_reservation" class="data-modal button-normal button-lblue" data-target="modal-reservaciones" disabled>Agregar Inventario</button>
    </div>
...
$(document).ready(function() {
    ...
    $("#property-list").change(function() {
        ...
        if($(this).val() == "") {
            ...
            $.ajax({
                type: "GET",
                url: "propertyInventory/getId&" + dataString,
                data: dataString,
                success: function(data) {
                    $(".table-main-inventory").html("");
                    console.log(data);
