...
( SELECT IFNULL(SUM(Ventas), 0) 'Ventas', IFNULL(SUM(Gastos), 0) 'Gastos', IFNULL(SUM(Descuentos), 0) 'Descuentos', IFNULL(SUM((Ventas - Gastos)), 0) 'Utilidad', IFNULL(SUM(DiasOcupacion), 0) 'DiasOcupacion' FROM
( SELECT p.id, p.name,
...
UNION SELECT id 'IdPropiedad', name 'Nombre', IFNULL(Ventas, 0), IFNULL(Gastos, 0), IFNULL(Descuentos, 0), IFNULL((Ventas - Gastos), 0) 'Utilidad', IFNULL(DiasOcupacion, 0) FROM
